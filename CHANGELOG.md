...
#### 用户体验
- 🎨 统一所有页面的卡片样式
  - 为 TabCard 添加 `min-h-[200px]` 确保所有页面卡片高度一致
  - 解决预设页、扩展页与表达式页、脚本页的卡片底部间隔不一致问题
  - 提升整体视觉统一性

- 🎨 增强卡片底部信息展示
  - 在日期/作者信息下方添加标签显示
  - 最多显示 3 个标签，超出部分显示 "+N" 提示
  - 使用主色背景的标签样式，提升视觉层次感

#### 代码质量
- 🔧 组件架构优化 - 创建 TabList 通用组件
  - 统一处理 ExpressionsTab、ScriptsTab、PresetsTab、ExtensionsTab 的逻辑
  - 减少代码重复约 600+ 行
  - 提升代码可维护性和一致性
