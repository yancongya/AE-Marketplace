...
**格式：** 不包含 `.md` 后缀
```markdown
✅ [开发指南](./extension-dev-guide)
✅ [脚本介绍](./what-is-scripts)
❌ [开发指南](./extension-dev-guide.md)  # 会导致路由错误
```

**只引用实际存在的文档：**
- 检查 `public/content/extensions/_manifest.json` 获取可用文档列表
- 当前可用：`what-is-scripts.md`, `extension-dev-guide.md`
